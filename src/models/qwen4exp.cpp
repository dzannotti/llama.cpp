...
void llama_model_qwen4exp::load_arch_hparams(llama_model_loader & ml) {
    ...
    // n_ff_exp became a per-layer array upstream (c61b98b87); #28243 still reads the scalar
...
ggml_tensor * llama_model_qwen4exp::graph::build_attn_qsa(
    ...
    // sparse attention: gather the top-k selected KV rows instead of masking the full cache
    // ref: https://github.com/ggml-org/llama.cpp/pull/27970, enablement from closed PR #28349
